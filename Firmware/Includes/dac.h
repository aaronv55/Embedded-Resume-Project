...
#define dac_enable_audio() gpio_clear(DAC_AUDIO_SHUTDOWN_PIN) //Logic low, amplifier is active
#define dac_disable_audio() gpio_set(DAC_AUDIO_SHUTDOWN_PIN) //Logic high, amplifier is in low power mode
...
e_dac_volume_type dac_get_volume(void);
void dac_set_volume(e_dac_volume_type tmp_volume_level);
